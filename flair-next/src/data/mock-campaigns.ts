...
export const mockBadges: Campaign[] = [
  {
    ...
    schedule: { startsAt: "2026-04-01T00:00:00Z", endsAt: null, timezone: "America/New_York", isActive: true, daysOfWeek: ["mon", "tue", "wed", "thu", "fri"], timeOfDayStart: "09:00", timeOfDayEnd: "21:00" },
    createdAt: "2026-03-15T10:00:00Z", updatedAt: "2026-04-01T08:00:00Z",
    targetScope: "product",
    ...
    abTestConfig: {
      enabled: true,
      testName: "Sale Badge Variants",
      variants: [
        { id: "var_a", name: "Dark Navy", creative: { text: "SITEWIDE SALE!\nEXTRA 20% OFF IN CART!!\nDiscount applied in cart.", backgroundColor: "#1a3a5c", textColor: "#ffffff", borderColor: "#1a3a5c", stylePreset: "solid-dark" }, allocationPercent: 50 },
        { id: "var_b", name: "Red Alert", creative: { text: "SITEWIDE SALE!\nEXTRA 20% OFF IN CART!!\nDiscount applied in cart.", backgroundColor: "#dc2626", textColor: "#ffffff", borderColor: "#dc2626", stylePreset: "solid-red" }, allocationPercent: 50 },
      ],
      winnerCriteria: "conversion",
    },
    metricsConfig: {
      enabled: true,
      trackingEnabled: true,
      roiTarget: 300,
      costPerImpression: 2.50,
      snapshots: [
        { timestamp: "2026-04-01T12:00:00Z", impressions: 5200, clicks: 342, conversions: 87, revenue: 4350, avgOrderValue: 50 },
        { timestamp: "2026-04-02T12:00:00Z", impressions: 6100, clicks: 418, conversions: 102, revenue: 5150, avgOrderValue: 50.49 },
      ],
    },
    notificationConfig: {
      emailOnLaunch: true,
      emailOnPause: true,
      emailOnWarnings: true,
      emailAddresses: ["marketing@gerber.com"],
      alertThresholds: { lowPerformanceRatio: 0.02, lowCTR: 0.05, conversionDrop: 0.3 },
    },
  },
  {
  ...
  },
  {
    ...
    schedule: { startsAt: "2026-03-01T00:00:00Z", endsAt: null, timezone: "America/New_York", isActive: true },
    createdAt: "2026-02-20T10:00:00Z", updatedAt: "2026-03-01T08:00:00Z",
    workflowConfig: {
      enabled: true,
      name: "Pajama Upsell Workflow",
      trigger: "campaign_start",
      steps: [
        { id: "step_1", type: "delay", delayHours: 24 },
        { id: "step_2", type: "notification", notificationType: "email" },
      ],
    },
    recommendationConfig: {
      enabled: true,
      basedOnInventory: true,
      basedOnSales: true,
      basedOnPerformance: true,
      recommendations: ["Increase time-of-day targeting to 9 AM - 8 PM (peak engagement)", "Consider A/B test for messaging variant"],
      lastUpdated: "2026-04-01T06:00:00Z",
    },
  },
  {
